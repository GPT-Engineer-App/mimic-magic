  ...
  return (
    <VStack p={8}>
      ...
      <HStack mb="4" spacing="24px">
        ...
        <>
          <Textarea placeholder="Enter text here" style={{ backgroundImage: imageDataUrl ? `url(${imageDataUrl})` : "none", backgroundSize: "cover", backgroundPosition: "center", width: "700px", height: "100px", backgroundRepeat: "no-repeat" }} />
        </>
      </HStack>
    </VStack>
  );
